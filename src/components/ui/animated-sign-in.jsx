      ...
      <div className="login-card">
        <div className="login-card-inner">
          ...
          <form className="login-form" onSubmit={handleSubmit}>
            ...
            <button type="submit" className="login-button" disabled={loading || (isFormSubmitted && (!email || !password || !isEmailValid))}>
          ...
          <div className="social-login">
            <button className="social-button github"><Github size={18} /></button>
            <button className="social-button twitter"><Twitter size={18} /></button>
            <button className="social-button linkedin"><Linkedin size={18} /></button>
          </div>
