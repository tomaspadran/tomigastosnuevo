                    ...
                    <div className="flex items-start md:items-center gap-6">
                        ...
                        <div className="flex flex-col space-y-1">
                            ...
                            <h1 className="text-5xl md:text-6xl font-black tracking-tightest text-foreground font-heading">
                                Estadísticas <span className="text-primary italic">Avanzadas</span>
                            </h1>
                            <p className="text-muted-foreground text-sm font-bold tracking-[0.2em] uppercase opacity-70">Análisis Profundo • 4K UHD Suite</p>
                        </div>
                    </div>
                </header>
